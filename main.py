...
jobs_df = scrape_jobs(
    ...
    search_term=f'"Graduate"',
    avoid_keywords='Care Finance Lecturer Warehouse Dentist Manager Accountant Operator Childcare Security Leader Kitchen Teaching DataAnnotation Painter TieTalent Senior "Bending Spoons" Surveyor Teaching Joiner Lead Executive',
...
add_to_spreadsheet(filtered_df, worksheet)
